...
function mapStateToProps(state) {
  return {
    data: state.veteran,
    isSectionComplete: state.uiState.completedSections['/who-are-you/name-and-general-information']
  };
}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    onUIStateChange: (update) => {
      dispatch(updateReviewStatus(['/who-are-you/name-and-general-information'], update));
    }
  };
}
