 ...
 */
class WhoAreYouPanel3 extends React.Component {
  render() {
    let content;
    let editButton;
...
function mapStateToProps(state) {
  return {
    data: state.veteran,
    isSectionComplete: state.uiState.completedSections['/who-are-you/panel3']
  };
}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    onUIStateChange: (update) => {
      dispatch(updateReviewStatus(['/who-are-you/panel3'], update));
    }
  };
}

// TODO(awong): Remove the pure: false once we start using ImmutableJS.
export default connect(mapStateToProps, mapDispatchToProps, undefined, { pure: false })(WhoAreYouPanel3);
export { WhoAreYouPanel3 };
