...
module.exports = {
  'Begin application': (client) => {
    ...
    client
      ...
      .assert.visible('select[name="suffix"]')
      ...
      .click('id=isAmericanIndianOrAlaskanNative')
      .click('isBlackOrAfricanAmerican')
      .setValue('select[name="isNativeHawaiianOrOtherPacificIslander"]', 'checked')
      .click('select[name="isAsian"]')
      .pause(10000)
      .click('.form-panel .usa-button-primary')
      .pause(1000)
